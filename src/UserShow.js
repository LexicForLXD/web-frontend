...
class UserShow extends Component {
  ...
  render() {
    return (
      <div>
        {this.state.redirect && <Redirect from="/users/show" exact to="/users" />}
        {this.state.notFound &&
            ...
            <Table bordered responsive striped>
              ...
              <tbody>
                <tr>
                  ...
                  <td>{this.state.user.roles.join(', ')}</td>
                  <td style={this.state.user.isActive ? { 'color': 'green' } : { 'color': 'red' }}>
                    {this.state.user.isActive && (this.state.user.isActive ? '\u2713' : '\u2715')}
                  </td>
                </tr>
              </tbody>
            </Table>
