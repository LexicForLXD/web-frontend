...
class ContainerShow extends Component {
  ...
  httpPutContainerState = action => {
    ...
    this.props.httpRequest(
      "PUT",
      `containers/${this.state.container.id}/state`,
      body,
      () => {
        this.httpGetContainer();
      }
  ...
  render() {
    return (
      <div>
        {this.state.redirect && (
          <Redirect from="/containers/show" exact to="/containers" />
        )}
          ...
          <tbody>
            <tr>
              ...
              <td>
                <Button
                  type="button"
                  onClick={() => this.httpPutContainerState("start")}
                >
                  <i className="fa fa-play" />
                </Button>
                <Button
                  type="button"
                  onClick={() => this.httpPutContainerState("stop")}
                >
                  <i className="fa fa-stop" />
                </Button>
                <Button
                  type="button"
                  onClick={() => this.httpPutContainerState("restart")}
                >
              ...
              <td>
                {this.state.container.host
                  ? this.state.container.host.name
                  : ""}
              </td>
            </tr>
          </tbody>
          ...
          <tbody>
            <tr>
              <td style={{ textAlign: "left" }}>
                <pre>
                  {JSON.stringify(this.state.container.settings, null, 2)}
                </pre>
              </td>
            </tr>
          </tbody>
        ...
        >
          <i className="fa fa-edit" /> Edit Container
        </Button>
        <Button
          type="button"
          className="Button"
        ...
        >
          <i className="fa fa-trash" /> Delete Container
        </Button>
        {this.state.editView && (
          <ContainerEdit
