    ...
    return (
      <Grid fluid>
        <Col xs={3} md={2}>
          ...
          <Sidebar
            parent={
              this.state.toggleContainers ? "logs/containers" : "logs/hosts"
            }
            refresh={this.getContainersAndHosts}
            items={
              this.state.toggleContainers
                ? this.props.containers
                : this.props.hosts
            }
            icon={this.state.toggleContainers ? "fa fa-cube" : "fa fa-server"}
          />
        </Col>
        <Col xs={9} md={10}>
          <Route
            ...
            path="/logs"
            render={() => (
              <h6>Please choose a container or host from the sidebar</h6>
            )}
          />
          <Route
            path={
              this.state.toggleContainers
                ? "/logs/containers/show"
                : "/logs/hosts/show"
            }
            render={() => (
              <LogShow
